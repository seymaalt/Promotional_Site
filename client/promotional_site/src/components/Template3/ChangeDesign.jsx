...
function ChangeDesign({ open, onClose, handleColorChange, handleFontChange, handleFontSizeChange, fontSize, selectedFont, color, modalPosition,handleTextAlignChange }) {
